...
@Component
public class CommRedisUtils {
	private static final Logger logger = LoggerFactory.getLogger(CommRedisUtils.class);
	
	@Autowired
	RedisTemplate<String,Object> redisTemplate;
	
	private final long DEFAULT_EXPIRE=60L*60*24*365;//默认过期时间一年
	
	private final String KEY_PREFIX="csb";//key的前缀
	...
	private StringBuilder getPreKey() {
		...
		String shortname =this.KEY_PREFIX/*this.configProperties.getAppshortname()*/;
